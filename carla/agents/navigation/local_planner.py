...
class LocalPlanner(object):
    ...
    def run_step(self, debug=False):
        ...
        # TODO: Раскоментируйте следующую строку кода чтобы видеть следующие 5 путевых точек движения,
        # для лучшего отображения сделаем на высоте 1-2 (Предупреждение: слишком яркий цвет)
        # draw_waypoints(self._vehicle.get_world(), [self.target_waypoint], 2.0)
