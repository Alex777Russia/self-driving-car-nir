...
class BasicAgent(object):
    ...
    def __init__(self, vehicle, target_speed=20, opt_dict={}, map_inst=None, grp_inst=None):
        ...
        # Base parameters
        self._ignore_traffic_lights = True # TODO: previous value=False
        self._ignore_stop_signs = False # TODO: previous value=False
        self._ignore_vehicles = False # TODO: previous value=False
    ...
    def set_destination(self, end_location, start_location=None):
        ...
        # TODO: Возвращает путь для того, чтобы потом отобразить его на карте мира (сверху)
        return route_trace
